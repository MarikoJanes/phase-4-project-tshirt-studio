...
function Front({ setSelectedColor, selectedColor, templates  }) {
    ...
    function handleCategoryFront(e) {
  ...
  return (
    <>
        ...
        {/* {loadedElements.length > 0 ? loadedElements.map(elem => {
          return <p>{elem.image}</p>
        }) : null} */}
        <select onChange={handleCategoryFront}>
